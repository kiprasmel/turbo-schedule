...
* use the proper path for statically built client in production ([b57cd08](https://github.com/sarpik/turbo-schedule/commit/b57cd087f1f87abebbb92b64968f05576c732632))





## [2.8.1](https://github.com/sarpik/turbo-schedule/compare/v2.8.0...v2.8.1) (2020-08-18)


### Bug Fixes

* redirect to API docs instead of providing them ([fc722cd](https://github.com/sarpik/turbo-schedule/commit/fc722cddc31292c3298cb972ea1a718ab6a04035))
...
* **ci:** add `--check-files` to `yarn install` ([f8d6cbc](https://github.com/sarpik/turbo-schedule/commit/f8d6cbc58a41c3c80bb1c55b41f5b6219bb3521d))
...
* Create a simple `yarn deve` script which includes `DEBUG=turbo-schedule*` ([f6f6287](https://github.com/sarpik/turbo-schedule/commit/f6f62878a7291440faa659f7d6cf990e118ede87))
...
* **ci:** Remove `saved-content` from cache ([cda3a5e](https://github.com/sarpik/turbo-schedule/commit/cda3a5ec8c670cec9b3f193be65d4e9d7bf1bc34))
...
* Remove a patch that does not serve us well:D ([d798d46](https://github.com/sarpik/turbo-schedule/commit/d798d4673261354acc9728caa688447210b1c24d)), closes [/github.com/mpashkovskiy/express-oas-generator/pull/32#issuecomment-546630020](https://github.com//github.com/mpashkovskiy/express-oas-generator/pull/32/issues/issuecomment-546630020)
