...
import { setLang, ILang, availableLangs } from "../i18n/i18n";
import { useTranslation } from "../i18n/useTranslation";

export const Navbar: FC<{
	searchElementRef: React.Ref<React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>>;
}> = forwardRef(({ searchElementRef }, ref) => {
