...
/**
 * TODO: consider using a parser-like approach with each child having a
 * `doesMatch` / `matches` filter fn instead of being this fragile
 * and relying on the items to be sorted in specific order
 */
// diffs
 ...
 * TODO FIXME HACK - temporarily using the manual value instead until this is resolved
 *
 * TODO use generated `ParticipantHierarchy` instead of `ParticipantHierarchyManual` as soon as possible.
