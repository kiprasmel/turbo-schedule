...
export const fuzzyMatch = (string: string, searchTermRef: string): boolean => {
	const hay = string.toLowerCase();
	const searchTerm: string = searchTermRef.toLowerCase();
...
export const fuzzyMatchV2 = (text: string, pattern: string, options: any = {}) => {
	...
	function match_bitapScore_(e: any, x: any) {
